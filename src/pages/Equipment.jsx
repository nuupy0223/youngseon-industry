  ...
  return (
      <div className="wrap">
        <div className="eq_bg h-[30vh] md:h-[18.75rem] overflow-hidden">
          <div className="area px-3.5 xl:px-0 mb-20 pb-10">
          <p className="pt-10 sm:pt-20 text-3xl leading-[2.8rem] text-blue pb-5 font-bold">포트폴리오</p>
            <span className="text-subgray leading-[1.8rem] text-over-ellipsis">영선산업은 이미지 홍보 단체 상품에 기업의 아이덴티티를 녹여내어<br className="hidden sm:block"/>
