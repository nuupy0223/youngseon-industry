...
function HomeMap() {
  return (
    <>
        <div className="wrap">
          <div className="hm_bg h-[30vh] md:h-[18.75rem]">
              <div className="area px-3.5 xl:px-0">
                <p className="pt-20 md:pt-28 text-3xl leading-[2.8rem] text-blue pb-5 font-bold">오시는 길</p>
        ...
        {/* 본문 시작 */}
        <div className="area pt-16 md:pb-48 pb-32">
        <div>
          <article className="grid grid-cols-[1.5fr_1fr] px-3.5 xl:px-0 gap-4">
          ...
          <div className="pt-20 md:pt-10 px-3.5 xl:px-0">
